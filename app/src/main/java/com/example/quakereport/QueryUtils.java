...
public class QueryUtils {
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            urlConnection.setRequestMethod("GET"); //Here get the method means to get Read mode from resources
    ...
    public static ArrayList<Earthquake> extractfeatureFromJson(String earthquakejson) {
        ...
        try {
            ...
            JSONObject basearray=new JSONObject(earthquakejson);
            JSONArray earthquakearray=basearray.getJSONArray("features");
